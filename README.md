...
Minkowski Distance: A generalized version of both Euclidean and Manhattan distances, where you can adjust the power parameter (p) to control the type of distance. In this script, the distance is calculated with 
